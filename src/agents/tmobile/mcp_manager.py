...
class MCPManager:
    def __init__(self, config_path="config-tmobile.yaml"):
        ...
        if config_content is None:
            ...
            print(f"Warning: No config.yaml file found. Using empty MCP config.")
        else:
            ...
            if atlassian_url:
                ...
                if "mcp" in self.config and "servers" in self.config["mcp"] and "atlassian" in self.config["mcp"]["servers"]:
